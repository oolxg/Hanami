...
enum MangaReadingViewStateEnum: Equatable {
...
enum MangaReadingViewActionEnum {
...
struct OnlineMangaReadingViewState: Equatable {
    init(mangaID: UUID, chapterID: UUID, chapterIndex: Double?, scanlationGroupID: UUID?, translatedLanguage: String, shouldSendUserToTheLastPage: Bool = false) {
...
let mangaReadingViewReducer: Reducer<MangaReadingViewStateEnum, MangaReadingViewActionEnum, MangaReadingViewEnvironment> = .combine(
