...
let offlineMangaReadingViewReducer: Reducer<OfflineMangaReadingViewState, OfflineMangaReadingViewAction, MangaReadingViewEnvironment> = Reducer { state, action, env in
    switch action {
        case .userStartedReadingChapter:
